...
import { PK_PATCH } from './dex/moves';
...
delete PK['Defense Curl'];
delete PK['Skull Bash'];
delete PK['Spike Cannon'];
delete PK['Barrage'];
delete PK['Psywave'];
delete PK['Splash'];
...
delete PK['Trick'];
delete PK['Snatch'];
delete PK['Arm Thrust'];
delete PK['Mud Sport'];
delete PK['Covet'];
delete PK['Water Sport'];
delete PK['Healing Wish'];
delete PK['Heal Block'];
delete PK['Switcheroo'];
delete (PK['Submission'] as any).recoil;
delete (PK['Superpower'] as any).self;
delete (PK['Overheat'] as any).self;
...
export const MOVES = [{}, RBY, GSC, ADV, PK, BW, XY, SM, SS, SV];
